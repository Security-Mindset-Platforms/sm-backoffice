...
import * as codeData from '../../../components/shared/prismData/spinners';
...
export class SpinnersComponent {
  ...
  ts8: string = codeData.spinnersTS8;
  ts9: string = codeData.spinnersTS9;
  ts10: string = codeData.spinnersTS10;
