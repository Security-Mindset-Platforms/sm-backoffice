...
export class AuthService {
  ...
  constructor(private httpClient: HttpClient, private afu: AngularFireAuth, private router: Router,public ngZone: NgZone) {
  ...
  login(data: any): Observable<any>{
    // const body = this.encodeData(data);
    return this.httpClient.post(environment.urlAPi+EndPoints.AUTH_URI, data,  this.options);
  }
